...
class Mesh : public HdMesh
{
  public:
    ...
    void Sync(HdSceneDelegate *pSceneDelegate, HdRenderParam *pRenderParam, HdDirtyBits *pDirtyBits,
              TfToken const &reprToken) override;

    void Finalize(HdRenderParam *renderParam) override;

    inline const uint64_t &GetResourceHandle() const
    {
        return m_ResourceHandle;
    }

    inline const GfMatrix4f &GetLocalToWorld() const
    {
